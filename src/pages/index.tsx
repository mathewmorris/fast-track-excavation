...
export const RequestQuoteButton = () => {
  return (
    <a 
      href="#request-quote"
      className="rounded-full bg-orange-600 hover:bg-orange-500 py-2 px-4 text-white font-bold"
    >
      Request a quote now!
    </a>
  );
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center">
        <section className="h-[32rem] w-full bg-[url('/hero.jpg')] bg-cover mb-4 relative">
          <div className="bg-green-950/60 absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
